...
import AnchorsOg, { size as anchorsSize, contentType as anchorsType } from '@/app/anchors/opengraph-image';
import AnchorDetailOg, { size as detailSize, contentType as detailType } from '@/app/anchors/[id]/opengraph-image';
import StandingsOg, { size as standingsSize, contentType as standingsType } from '@/app/anchors/standings/opengraph-image';
import MethodologyOg, { size as methodologySize, contentType as methodologyType } from '@/app/methodology/opengraph-image';
