  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        >
          How we measure uptime, quote availability, issuer mismatch, and stellar.toml integrity
          without relying on trusted oracles.
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', fontSize: 26, color: ACCENT }}>Open Scoring Model</div>
      </div>
    </div>,
    { ...size }
  );
