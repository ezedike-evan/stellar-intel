...
export const alt = 'Stellar Intel Developer Portal & API Reference';
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        >
          Integrate Stellar anchor health metrics, MCP tools, TypeScript SDKs, and REST endpoints directly into your wallet or app.
        </div>
      </div>
