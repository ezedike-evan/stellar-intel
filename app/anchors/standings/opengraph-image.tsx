...
export const alt = 'Stellar Anchor Standings & Rankings — Stellar Intel';
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        >
          Objective rankings of Stellar off-ramp anchors based on four transparent health signals —
          uptime, quote availability, issuer mismatch, and TOML validation.
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', fontSize: 26, color: ACCENT }}>Verified Standings</div>
      </div>
    </div>,
    { ...size }
  );
