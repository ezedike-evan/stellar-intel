  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        >
          Every registered off-ramp anchor, probed every five minutes across uptime, quote
          availability, and TOML integrity.
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', fontSize: 26, color: ACCENT }}>Live Anchor Directory</div>
      </div>
    </div>,
    { ...size }
  );
