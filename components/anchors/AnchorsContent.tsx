...
/**
 * components/anchors/AnchorsContent.tsx
 *
 * Client component for the /anchors page.  Extracted from app/anchors/page.tsx
 * so that page can be a React Server Component — enabling server-side JSON-LD
 * injection without adding a client/server boundary inside the page module.
 *
 * All state and routing logic that required `'use client'` lives here.
 */
